    ...
    const AllRoutes = () => {
        return (
            <Routes>
                ...
                <Route exact path="/resources/blogs" name="Blogs" element={<ProtectedRoutes Component={Blogs} accessRights={"guest"} />} />
                ...
                <Route exact path="/resources/blogs/:type/:id" name="Specific Blog2" element={<ProtectedRoutes Component={BlogToDisplay} accessRights={"guest"} />} />
                ...
                <Route path="/service/compare/:service?" name="Compare" element={<ProtectedRoutes Component={CompareServices} accessRights={"guest"} />} />
